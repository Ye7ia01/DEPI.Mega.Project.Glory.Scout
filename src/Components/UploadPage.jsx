...
const UploadPage = () => {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..uT6ViO1zsLNzrhfqS_YDwcAUPiRhgXuWB3IbE-SZ5wM";
...
//        setTimeout(()=>navigate("/player-profile", { state: { newPostAdded: true } }),2000)
//       } else {
//         setSnackbar({
//           open: true,
