...
/>
              ...
              <i className="bi bi-send text-white position-absolute" 
                 style={{ right: '10px', top: '50%', transform: 'translateY(-50%)', fontSize: '18px' }}></i>
            </div>
          </div>

          {/* Links Columns */}
          <div className="col-md-2 mb-4">
            <h6 className=" mb-3" style={{ color: '#33FF33' }}>Home</h6>
          ...
          <div className="col-md-2 mb-4">
            <h6 className=" mb-3" style={{ color: '#33FF33' }}>About Us</h6>
            <ul className="list-unstyled">
              <li>Our Story</li>
              <li>Our Works</li>
              <li>How It Works</li>
          ...
          <div className="col-md-2 mb-4">
            <h6 className="mb-3" style={{ color: '#33FF33' }}>Players</h6>
            <ul className="list-unstyled">
              <li>Portfolio</li>
              <li>Categories</li>
            </ul>
          ...
          <div className="col-md-2 mb-4">
            <h6 className=" mb-3" style={{ color: '#33FF33' }}>Services</h6>
            <ul className="list-unstyled">
              <li>FAQ</li>
          ...
          <div className="col-md-2 mb-4">
            <h6 className="mb-3" style={{ color: '#33FF33' }}>Contact Us</h6>
            <ul className="list-unstyled">
              <li>Contact Form</li>
              <li>Our Offices</li>
            </ul>
