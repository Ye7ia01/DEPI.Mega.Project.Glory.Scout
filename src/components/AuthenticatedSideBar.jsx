  ...
  return (
    <>
      {collapsed && (
        <Navbar
          variant="dark"
          className="d-flex flex-column ps-4 align-items-start side-bar"
        >
          <Nav className="d-flex flex-column justify-content-evenly">
            ...
            <Nav.Item>
              ...
              >
                <Image
                  className={`me-3 svg-icon img-fluid ${
                    activePage === "home" ? "svg-icon-active" : ""
                  }`}
                  src={Home}
                  width="20px"
                  height="20px"
            ...
            <Nav.Item className="">
              ...
              >
                <Image
                  ...
                  height="20px"
                  className={`me-3 svg-icon img-fluid ${
                    activePage === "email" ? "svg-icon-active" : ""
                  }`}
                />
                <span
                  className={`side-bar-items ${
                    activePage === "email" ? "active" : ""
                  }`}
                >
                  Email
                </span>
            ...
            <Nav.Item className="">
              ...
              >
                <Image
                  className={`me-3 svg-icon img-fluid ${
                    activePage === "faq" ? "svg-icon-active" : ""
                  }`}
                  src={FAQ}
                  width="20px"
                  height="20px"
            ...
            <Nav.Item className="">
              ...
              >
                <Image
                  className={`me-3 svg-icon img-fluid ${
                    activePage === "contact" ? "svg-icon-active" : ""
                  }`}
                  src={Contact}
                  width="20px"
                  height="20px"
            ...
            {user.user_type === UserType.PLAYER && (
              <Nav.Item className="">
                ...
                >
                  <Image
                    className={`me-3 svg-icon img-fluid ${
                      activePage === "players" ? "svg-icon-active" : ""
                    }`}
                    src={Player}
                    width="20px"
                    height="20px"
            ...
            {user.user_type === UserType.COACH && (
              <Nav.Item className="">
                ...
                >
                  <Image
                    className={`me-3 svg-icon img-fluid ${
                      activePage === "coaches" ? "svg-icon-active" : ""
                    }`}
                    src={Player}
                    width="20px"
                    height="20px"
            ...
            <Nav.Item className="">
              ...
              >
                <Image
                  className={`me-3 svg-icon img-fluid ${
                    activePage === "settings" ? "svg-icon-active" : ""
                  }`}
                  src={Settings}
                  width="20px"
                  height="20px"
